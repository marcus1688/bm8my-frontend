<template>
  <section v-if="userData" class="py-3 max-lg:py-2">
    <div class="mx-auto containerWid lg:hidden">
      <div
        class="flex justify-between items-center bg-[#241017] border border-[#3b1c23] rounded-lg px-4 py-3 max-lg:px-2 max-lg:py-2 gap-3"
      >
            ...
            <div class="flex items-stretch w-full gap-2">
              <div class="flex flex-col gap-1 items-center">
                <img
                  ...
                  alt="User"
                  class="w-8 h-8 max-lg:w-10 max-lg:h-auto max-[360px]:w-7 max-[360px]:h-7"
                />
              ...
              <div class="flex flex-col gap-1 w-full">
                ...
                >
                  <div class="flex flex-col flex-1 min-w-0">
                    <span
                      class="text-[#f0eaea] font-bold max-lg:text-sm max-[360px]:text-[0.8rem]"
                    >
        ...
        <div class="flex items-center gap-3 max-lg:gap-2 flex-shrink-0">
          ...
          >
            ...
            >
              <i
                class="bi bi-wallet-fill text-white text-lg max-lg:text-base max-[360px]:text-sm"
              ></i>
            </div>
            <span
          ...
          >
            ...
            >
              <i
                class="bi bi-cash-coin text-white text-lg max-lg:text-base max-[360px]:text-sm"
              ></i>
            </div>
            <span
              class="text-[#f0eaea] text-[10px] max-lg:text-[9px] font-medium"
